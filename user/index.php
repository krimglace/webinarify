...
<style>
  ...
  .event-webinar{
    ...
    <div class="top-search">
      ...
      <input type="search" class="pencarian" placeholder="Cari Event Webinar">
    </div>
    ...
    <div class="beranda-content text-white container-fluid">
      ...
      <div class="kategori">
        ...
        <div class="kategori-item text-dark bg-white">
          <a href="daftar-event.php?id=<?= $resultKategori['id_kategoriwebinar']?>&&kategori=<?=$resultKategori['nama_kategoriwebinar']?>&&<?= base64_encode(random_bytes(32)) ?>" class="text-dark">
        ...
        <a style="text-decoration:none" href="#" class="float-end text-secondary me-4"><h4>Lihat Lainnya <i class="fas fa-angle-right"></i></h4></a>
        <div class="clearfix"></div>
      </div>
       ...
       <?php
        ...
        <div class="event-webinar text-dark bg-white">
          ...
          <div class="float-start ms-5 col-8">
            ...
            <a class="text-primary mt-4" href="detail-event.php?id=<?=$resultEvent['id_event']?>&&<?=base64_encode(random_bytes(32))?>" style="text-decoration: none;">
              <h3>
            ...
            <a style="position: absolute; bottom: 15px; right: 25px; background-color: #52A6BE; text-decoration:none; border-radius: 25px;" href="detail-event.php?id=<?=$resultEvent['id_event']?>&&<?=base64_encode(random_bytes(32))?>" class="text-white ps-3 pe-3">
              Detail Lainnya
            </a>
              <div class="clearfix"></div>
          </div>
