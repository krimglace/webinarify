...
<html lang="en">
  ...
  <body style="background-image: url('assets/img/latar2.png')">
    <nav class="navbar-menu container-fluid">
      ...
      <div class="top-top-menu float-end col-6 text-end">
        <div class="top-menu">
          <ul class="menu-cover text-white">
            <li class="menu-content"><a href="index.php">Beranda</a></li>
            <li class="menu-content"><a onclick="haruslogin()">Kontak Kami</a></li>
            <li class="menu-content login-tab"><a href="login.php" class="bg-secondary">Masuk</a></li>
          </ul>
        </div>
      </div>
